...
#Создаем классы бирж:
bd = MarketClass.bd
Poloniex = MarketClass.Poloniex_Andy_blm_shared
Exmo = MarketClass.Exmo_Andy_blm_shared
Bitfinex = MarketClass.Bitfinex_blm
Wex = MarketClass.Wex('Wex','asfasfasf','asfasfasf')
ver = 'log_2.6.2'
account = 'Andy_blm_shared'
Withdrawal_fee_count = 10000 #Ожидаемое кол-во сделок перед выводом
want_profit = 0.33 #Желаемый профит В Процентах
balans_formated = [['BTC', 0.005, 0.0001, 0.001], ['BCH', 0.1, 0.0001, 0.001], ['ZEC', 0.5, 0.001, 0.001], ['DASH', 0.4, 0.01, 0.01], ['ETH', 0.5, 0.005, 0.01], ['LTC', 2.5, 0.001, 0.01], ['XRP', 850, 0.15, 0.02],
                   ['XMR', 1.4, 0.05, 0.05], ['ETC', 10, 0.01, 0.01]] #Валюта, Баланс,  Коммисия на вывод с Polo, Exmo, Bitfinex, WEX
...
timer_statistic = 0
while x < 1:
    time.sleep(0.33) #В целях экономия процессорного времени
