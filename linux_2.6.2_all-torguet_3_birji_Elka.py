...
#Создаем классы бирж:
bd = MarketClass.bd
Poloniex = MarketClass.Poloniex_Elka
Exmo = MarketClass.Exmo_Elka
Bitfinex = MarketClass.Bitfinex_Elka
Wex = MarketClass.Wex_Elka
ver = 'log_2.6.2'
account = 'Elka'
Withdrawal_fee_count = 10000 #Ожидаемое кол-во сделок перед выводом
want_profit = 0.12 #Желаемый профит В Процентах
...
balans_formated = [['BTC', 0.01, 0.0001, 0.001], ['BCH', 0.1, 0.0001, 0.001], ['ZEC', 0.5, 0.001, 0.001], ['DASH', 0.4, 0.01, 0.01], ['ETH', 0.5, 0.005, 0.01], ['LTC', 2.5, 0.001, 0.01], ['XRP', 850, 0.15, 0.02],
